...
export class TeacherService {
  ...
  getSingleTeacherInformation(id: string) {
    return this.authHttp.get(this.url + '/get/teacher/information/' + id)
      .map(res => res.json());
  }

  // Delete teacher
  deleteTeacher(id: string) {
    return this.authHttp.delete(this.url + '/delete/teacher/' + id)
      .map(res => res.json());
  }
